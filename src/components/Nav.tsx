...
const NavItem = (props: NavItemProps) => {
  ...
  return (
    <li className="m-0 text-center">
      <a
        className="block w-full px-4 py-2 text-blue-950 transition hover:bg-blue-500 md:rounded-full md:hover:bg-blue-50/25"
        href={href}
      >
        {children}
      </a>
    ...
    <nav className="absolute z-10 w-full">
      <div className="container mx-auto flex w-full max-w-screen-xl justify-between px-5 py-4 md:p-14 md:py-8">
        ...
        <div className="flex items-center">
          ...
          <ul
            className={cx(
              "absolute left-0 top-24 w-full flex-col divide-y divide-blue-500 bg-blue-400 text-blue-950 sm:relative sm:top-0 sm:flex sm:flex-row sm:gap-16 sm:divide-y-0 sm:bg-transparent",
